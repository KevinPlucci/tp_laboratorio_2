...
namespace Entidades
{
    ...
    public abstract class Producto : Interfaces
    {
        ...
        /// </summary>
        ///<param name="id">Le asigna una pulgadas al atributo id de producto</param>
        ...
        public Producto(int id, int pulgadas, ECalidad calidad)
        {
            this.Id = id;
